            ...
            <div class="row">
                ...
                <div class="left">
                    <div class="signup-search-area d-flex align-items-center justify-content-end">
                        <a>Welcome | </button><?php echo $_SESSION['username']; ?> &nbsp<button class="btn"><i class="fa fa-user"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="logo_area text-center">
                        <a href="admin-home.php" class="pizza-logo">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="pizza">
                            <ul class="navbar-nav" id="pizza-nav">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="admin-inventory.php">Orders<span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-ling" href="history.php">History</a>
                                </li>
                                <li class="nav-item">
...
<table class="table table-xl-responsive"  style="margin-top: -100px">
        ...
        <?php 
            $ordered = 'Ordered';
            $sql        = "SELECT * FROM orders WHERE user_id = '$user' AND order_state = '$ordered'";
